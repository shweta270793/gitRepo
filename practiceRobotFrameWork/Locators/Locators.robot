*** Variables ***
${BodybeastURL}  http://www.teambeachbody.com/
${TbbMainSiteUrl}   http://wave1tbbqa2.beachbody.local/home
...
${confirm_your_coach}     id=_TBBSIGNUP_WAR_signuprefactorportlet_lookupCoachBtn
